...
const typename Instruction<M>::opcode_entry Instruction<M>::Opcodes_2Byte_NA[0x100] = {
	...
	/* 0x0f 0x20 - 0x0f 0x2f */
	{ "mov",       &Instruction::decode_Rd_Cd,   OP_MOV,       FLAG_W_FLAGS },
	{ "mov",       &Instruction::decode_Rd_Dd,   OP_MOV,       FLAG_W_FLAGS },
	{ "mov",       &Instruction::decode_Cd_Rd,   OP_MOV,       FLAG_W_FLAGS },
	{ "mov",       &Instruction::decode_Dd_Rd,   OP_MOV,       FLAG_W_FLAGS },
	{ "invalid",   &Instruction::decode_invalid, OP_INVALID,   FLAG_NONE },
	{ "invalid",   &Instruction::decode_invalid, OP_INVALID,   FLAG_NONE },
	{ "invalid",   &Instruction::decode_invalid, OP_INVALID,   FLAG_NONE },
	{ "invalid",   &Instruction::decode_invalid, OP_INVALID,   FLAG_NONE },
	...
	{ "ucomiss",   &Instruction::decode_Vo_Wo,   OP_UCOMISS,   FLAG_W_FLAGS },
	...
	{ "sysenter", &Instruction::decode0,         OP_SYSENTER, FLAG_W_FLAGS },
	{ "sysexit",  &Instruction::decode0,         OP_SYSEXIT,  FLAG_W_FLAGS },
	{ "invalid",  &Instruction::decode_invalid,  OP_INVALID,  FLAG_NONE },
	...
	{ "vmread",  &Instruction::decode_Ed_Gd,    OP_VMREAD,  FLAG_W_FLAGS }, // x86-64: vmread Eq, Gq
	{ "vmwrite", &Instruction::decode_Gd_Ed,    OP_VMWRITE, FLAG_W_FLAGS }, // x86-64: vmwrite Gq, Eq
	{ "invalid", &Instruction::decode_invalid,  OP_INVALID, FLAG_NONE },
	{ "invalid", &Instruction::decode_invalid,  OP_INVALID, FLAG_NONE },
	{ "invalid", &Instruction::decode_invalid,  OP_INVALID, FLAG_NONE },
	{ "invalid", &Instruction::decode_invalid,  OP_INVALID, FLAG_NONE },
