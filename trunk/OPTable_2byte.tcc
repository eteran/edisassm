...
const typename Instruction<Model>::OpcodeEntry Instruction<Model>::Opcodes_2Byte_NA[0x100] = {
	...
	/* 0x0f 0x50 - 0x0f 0x5f */
	{ "movmskps", &Instruction::decode_Gd_Uo, OP_MOVMSKPS },	// x86-64: movmskps Gq, Uo
	...
	{ "invalid", &Instruction::decode_invalid, OP_INVALID },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID },
	{ "movd", &Instruction::decode_Pd_Ed, OP_MOVD },		// x86-64: movq Pd, Eq
	...
	{ "vmread", &Instruction::decode_Ed_Gd, OP_VMREAD },	// x86-64: vmread Eq, Gq
	{ "vmwrite", &Instruction::decode_Gd_Ed, OP_VMWRITE },	// x86-64: vmwrite Gq, Eq
	{ "invalid", &Instruction::decode_invalid, OP_INVALID },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID },
	{ "movd", &Instruction::decode_Ed_Pd, OP_MOVD },		// x86-64: movq Eq,Pd
	...
	/* 0x0f 0xa0 - 0x0f 0xaf */
	{ "push", &Instruction::decode_SegFS, OP_PUSH },
	{ "pop", &Instruction::decode_SegFS, OP_POP },
	{ "cpuid", &Instruction::decode0, OP_CPUID },
	{ "bt", &Instruction::decode_Ev_Gv, OP_BT },
	{ "shld", &Instruction::decode_Ev_Gv_Ib, OP_SHLD },
	{ "shld", &Instruction::decode_Ev_Gv_CL, OP_SHLD },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID },
	{ "push", &Instruction::decode_SegGS, OP_PUSH },
	{ "pop", &Instruction::decode_SegGS, OP_POP },
	{ "rsm", &Instruction::decode0, OP_RSM },
	{ "bts", &Instruction::decode_Ev_Gv, OP_BTS },
	{ "shrd", &Instruction::decode_Ev_Gv_Ib, OP_SHRD },
	{ "shrd", &Instruction::decode_Ev_Gv_CL, OP_SHRD },
	...
	{ "movnti", &Instruction::decode_Md_Gd, OP_MOVNTI },	// x86-64: movnti Nq, Gq
	{ "pinsrw", &Instruction::decode_Pq_Rd_Mw_Ib, OP_PINSRW },	// x86-64: pinsrw Pq, Rq/Mw,Ib
...
const typename Instruction<Model>::OpcodeEntry Instruction<Model>::Opcodes_2Byte_66[0x100] = {
	...
	/* 0x0f 0x50 - 0x0f 0x5f */
	{ "movmskpd", &Instruction::decode_Gd_Uo, OP_MOVMSKPD },	// x86-64: movmskpd Gq, Uo
	...
	{ "movd", &Instruction::decode_Vo_Ed, OP_MOVD },		// x86-64: movq Vo, Eq
	...
	{ "movd", &Instruction::decode_Ed_Vo, OP_MOVD },		// x86-64: movq Eq, Vo
	...
	{ "movnti", &Instruction::decode_Md_Gd, OP_MOVNTI },	// x86-64: movnti Nq, Gq
	{ "pinsrw", &Instruction::decode_Vo_Rd_Mw_Ib, OP_PINSRW },	// x86-64: pinsrw Vo, Rq/Mw,Ib
...
const typename Instruction<Model>::OpcodeEntry Instruction<Model>::Opcodes_2Byte_F2[0x100] = {
	...
	{ "movaps", &Instruction::decode_Vo_Wo, OP_MOVAPS },
	{ "movaps", &Instruction::decode_Wo_Vo, OP_MOVAPS },
	{ "cvtsi2sd", &Instruction::decode_Vo_Ed, OP_CVTSI2SD },	// x86-64: cvtsi2sd Vo, Eq
	{ "movntps",  &Instruction::decode_Mo_Vo, OP_MOVNTPS },	
	{ "cvttsd2si",  &Instruction::decode_Gd_Wo, OP_CVTTSD2SI },	// x86-64: cvttsd2si Gq, Wo
	{ "cvtsd2si",  &Instruction::decode_Gd_Wo, OP_CVTSD2SI },	// x86-64: cvtsd2si Gq, Wo
	{ "ucomiss",  &Instruction::decode_Vo_Wo, OP_UCOMISS },
	{ "comiss",  &Instruction::decode_Vo_Wo, OP_COMISS },
...
const typename Instruction<Model>::OpcodeEntry Instruction<Model>::Opcodes_2Byte_F3[0x100] = {
	...
	{ "movaps", &Instruction::decode_Vo_Wo, OP_MOVAPS },
	{ "movaps", &Instruction::decode_Wo_Vo, OP_MOVAPS },
	{ "cvtsi2ss", &Instruction::decode_Vo_Ed, OP_CVTSI2SS },	// x86-64: cvtsi2ss Vo, Eq
	{ "movntps",  &Instruction::decode_Mo_Vo, OP_MOVNTPS },	
	{ "cvttss2si",  &Instruction::decode_Gd_Wo, OP_CVTTSS2SI },	// x86-64: cvttss2si Gq, Wo
	{ "cvtss2si",  &Instruction::decode_Gd_Wo, OP_CVTSS2SI },	// x86-64: cvtss2si Gq, Wo
	{ "ucomiss",  &Instruction::decode_Vo_Wo, OP_UCOMISS },
	{ "comiss",  &Instruction::decode_Vo_Wo, OP_COMISS },
