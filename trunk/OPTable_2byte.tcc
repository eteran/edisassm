...
const typename Instruction<M>::opcode_entry Instruction<M>::Opcodes_2Byte_NA[0x100] = {
	...
	{ "vmread",  &Instruction::decode_Ed_Gd,    OP_VMREAD,  FLAG_INTEL_VT | FLAG_W_FLAGS }, // x86-64: vmread Eq, Gq
	{ "vmwrite", &Instruction::decode_Gd_Ed,    OP_VMWRITE, FLAG_INTEL_VT | FLAG_W_FLAGS }, // x86-64: vmwrite Gq, Eq
	{ "invalid", &Instruction::decode_invalid,  OP_INVALID, FLAG_NONE },
	{ "invalid", &Instruction::decode_invalid,  OP_INVALID, FLAG_NONE },
	{ "invalid", &Instruction::decode_invalid,  OP_INVALID, FLAG_NONE },
	{ "invalid", &Instruction::decode_invalid,  OP_INVALID, FLAG_NONE },
