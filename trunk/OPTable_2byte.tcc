...
const typename Instruction<M>::opcode_entry Instruction<M>::Opcodes_2Byte_NA[0x100] = {
	...
	/* 0x0f 0x50 - 0x0f 0x5f */
	{ "movmskps", &Instruction::decode_Gd_Uo, OP_MOVMSKPS, FLAG_NONE, 2 },	// x86-64: movmskps Gq, Uo
	...
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE, -1 },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE, -1 },
	{ "movd", &Instruction::decode_Pd_Ed, OP_MOVD, FLAG_NONE, 2 },		// x86-64: movq Pd, Eq
	...
	{ "vmread", &Instruction::decode_Ed_Gd, OP_VMREAD, FLAG_NONE, 2 },	// x86-64: vmread Eq, Gq
	{ "vmwrite", &Instruction::decode_Gd_Ed, OP_VMWRITE, FLAG_NONE, 2 },	// x86-64: vmwrite Gq, Eq
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE, -1 },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE, -1 },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE, -1 },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE, -1 },
	{ "movd", &Instruction::decode_Ed_Pd, OP_MOVD, FLAG_NONE, 2 },		// x86-64: movq Eq,Pd
	...
	/* 0x0f 0xa0 - 0x0f 0xaf */
	{ "push", &Instruction::decode_SegFS, OP_PUSH, FLAG_NONE, 1 },
	{ "pop", &Instruction::decode_SegFS, OP_POP, FLAG_NONE, 1 },
	...
	{ "shld", &Instruction::decode_Ev_Gv_CL, OP_SHLD, FLAG_NONE, 3 },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE, -1 },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE, -1 },
	{ "push", &Instruction::decode_SegGS, OP_PUSH, FLAG_NONE, 1 },
	{ "pop", &Instruction::decode_SegGS, OP_POP, FLAG_NONE, 1 },
	...
	{ "shrd", &Instruction::decode_Ev_Gv_CL, OP_SHRD, FLAG_NONE, 3 },
	...
	{ "movnti", &Instruction::decode_Md_Gd, OP_MOVNTI, FLAG_NONE, 2 },	// x86-64: movnti Nq, Gq
	{ "pinsrw", &Instruction::decode_Pq_Rd_Mw_Ib, OP_PINSRW, FLAG_NONE, 3 },	// x86-64: pinsrw Pq, Rq/Mw,Ib
...
const typename Instruction<M>::opcode_entry Instruction<M>::Opcodes_2Byte_66[0x100] = {
	...
	/* 0x0f 0x50 - 0x0f 0x5f */
	{ "movmskpd", &Instruction::decode_Gd_Uo, OP_MOVMSKPD, FLAG_NONE, 2 },	// x86-64: movmskpd Gq, Uo
	...
	{ "movd", &Instruction::decode_Vo_Ed, OP_MOVD, FLAG_NONE, 2 },		// x86-64: movq Vo, Eq
	...
	{ "movd", &Instruction::decode_Ed_Vo, OP_MOVD, FLAG_NONE, 2 },		// x86-64: movq Eq, Vo
	...
	{ "movnti", &Instruction::decode_Md_Gd, OP_MOVNTI, FLAG_NONE, 2 },	// x86-64: movnti Nq, Gq
	{ "pinsrw", &Instruction::decode_Vo_Rd_Mw_Ib, OP_PINSRW, FLAG_NONE, 3 },	// x86-64: pinsrw Vo, Rq/Mw,Ib
...
const typename Instruction<M>::opcode_entry Instruction<M>::Opcodes_2Byte_F2[0x100] = {
	...
	{ "movaps", &Instruction::decode_Vo_Wo, OP_MOVAPS, FLAG_NONE, 2 },
	{ "movaps", &Instruction::decode_Wo_Vo, OP_MOVAPS, FLAG_NONE, 2 },
	{ "cvtsi2sd", &Instruction::decode_Vo_Ed, OP_CVTSI2SD, FLAG_NONE, 2 },	// x86-64: cvtsi2sd Vo, Eq
	{ "movntps",  &Instruction::decode_Mo_Vo, OP_MOVNTPS, FLAG_NONE, 2 },
	{ "cvttsd2si",  &Instruction::decode_Gd_Wo, OP_CVTTSD2SI, FLAG_NONE, 2 },	// x86-64: cvttsd2si Gq, Wo
	{ "cvtsd2si",  &Instruction::decode_Gd_Wo, OP_CVTSD2SI, FLAG_NONE, 2 },	// x86-64: cvtsd2si Gq, Wo
	{ "ucomiss",  &Instruction::decode_Vo_Wo, OP_UCOMISS, FLAG_NONE, 2 },
	{ "comiss",  &Instruction::decode_Vo_Wo, OP_COMISS, FLAG_NONE, 2 },
...
const typename Instruction<M>::opcode_entry Instruction<M>::Opcodes_2Byte_F3[0x100] = {
	...
	{ "movaps", &Instruction::decode_Vo_Wo, OP_MOVAPS, FLAG_NONE, 2 },
	{ "movaps", &Instruction::decode_Wo_Vo, OP_MOVAPS, FLAG_NONE, 2 },
	{ "cvtsi2ss", &Instruction::decode_Vo_Ed, OP_CVTSI2SS, FLAG_NONE, 2 },	// x86-64: cvtsi2ss Vo, Eq
	{ "movntps",  &Instruction::decode_Mo_Vo, OP_MOVNTPS, FLAG_NONE, 2 },
	{ "cvttss2si",  &Instruction::decode_Gd_Wo, OP_CVTTSS2SI, FLAG_NONE, 2 },	// x86-64: cvttss2si Gq, Wo
	{ "cvtss2si",  &Instruction::decode_Gd_Wo, OP_CVTSS2SI, FLAG_NONE, 2 },	// x86-64: cvtss2si Gq, Wo
	{ "ucomiss",  &Instruction::decode_Vo_Wo, OP_UCOMISS, FLAG_NONE, 2 },
	{ "comiss",  &Instruction::decode_Vo_Wo, OP_COMISS, FLAG_NONE, 2 },
