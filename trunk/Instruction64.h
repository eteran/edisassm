...
const Instruction<edisassm::x86_64>::opcode_entry Instruction<edisassm::x86_64>::Opcodes_2Byte_NA[0x100] = {
	...
	/* 0x0f 0xa0 - 0x0f 0xaf */
	{ "push", &Instruction::decode_Reg<operand_t::REG_FS>, OP_PUSH, FLAG_STACK },
	{ "pop", &Instruction::decode_Reg<operand_t::REG_FS>, OP_POP, FLAG_STACK },
	...
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE },
	{ "invalid", &Instruction::decode_invalid, OP_INVALID, FLAG_NONE },
	{ "push", &Instruction::decode_Reg<operand_t::REG_GS>, OP_PUSH, FLAG_STACK },
	{ "pop", &Instruction::decode_Reg<operand_t::REG_GS>, OP_POP, FLAG_STACK },
